      ...
      {isHeaderVisible && (
        ...
        >
          <div className="section-container text-center text-muted-foreground">
            <p className="text-xs tracking-wide mx-auto">&copy; {new Date().getFullYear()} Svetlana Zharskaya. Crafting incredible stuff since 2008. Now with a sprinkle of AI.</p>
          </div>
        </motion.footer>
      )}
    </AnimatePresence>
