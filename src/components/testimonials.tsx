...
function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  return (
    <div className="flex-shrink-0 w-full md:w-1/2 lg:w-1/3 px-4">
      ...
      >
        <Quote className="w-8 h-8 text-muted/20 mb-4" />
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="mx-auto text-center px-6 md:px-8 xl:px-12 mb-12 md:mb-16"
      >
        <h2>
      ...
      <motion.div 
        className="relative max-w-7xl mx-auto px-6 md:px-8 xl:px-12"
        initial={{ opacity: 0, y: 24 }}
        animate={isHeroAnimationComplete ? { opacity: 1, y: 0 } : { opacity: 0, y: 24 }}
